...
export const Body2 = () => {
    return (
      <div className="Body2 " >
        <div data-aos="fade-up"  data-aos-duration="1000" className="Body2Text1 ">Meet Quality, Get Value</div>
        <div data-aos="flip-up"  data-aos-delay="50" data-aos-duration="1000" className="Body2Text2 ">Travel Riders - We Ride You To Your Destinations </div>
        <div data-aos="fade-down"  data-aos-delay="100" data-aos-duration="1000" className="Body2Text3 ">We Are On A Mission To Make Traveling Around The World Easy by creating
  ...
  const IconCircleContainer = ({ dataAos = "fade-down", IconName = faHourglass, title = '', caption = '' }) => {
    return (
      <div data-aos={dataAos}  data-aos-delay="400" data-aos-duration="2000" className="iconCircleContainer" >
        <div className="CircleContainer ">
          <div data-aos={'fade'}  data-aos-delay="600" data-aos-duration="3000" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%' }}>
