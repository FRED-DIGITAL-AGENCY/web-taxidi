...
export const Footer = ({ delay = '1000' }) => {
  return (
    <div data-aos={'fade'} data-aos-delay={delay} data-aos-duration="1000" className="FooterContainer">
      ...
      <div className="Footers">
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }} className="FooterLeft">
          <div style={{ display: 'flex', flexDirection: 'column', width:'75%'}}>
            ...
            <div className="FooterLeftText">Email: <br /><span>info@fredmindtaxidi.com | admissons@fredmindtaxidi.com | visa@fredmindtaxidi.com</span> </div>
            <div className="FooterLeftText">Phone: <br /> <span>+234916 219 3733</span> </div>
            <div className="FooterLeftText">Address: <br /> <span>Dalaba Street, Third Floor, Novare Central Office, Shoprite Building, Wuse Zone 5, Abuja</span></div>
            <div className="FooterLeftText FooterLeftTexticon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt" viewBox="0 0 16 16">
